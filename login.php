...
@ $db = new mysqli('localhost', 'root', 'olga', 'lab3');
    ...
    <body>
        ...
        if (isset($totalcount)) {
            if ($totalcount == 0) {
                ...
                echo '<h2>Welcome! Correct password.</h2> <h3> Feel free to upload pictures </h3> <a href=\lab_3/fileUpload.php\>Upload Pictures.</a>';
            }
        }
        ?>
        ...
        <div><a href="index.php">Return to startpage. </a></div> 
